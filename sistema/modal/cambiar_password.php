	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  ...
		  <div class="modal-body">
			...
			<div id="resultados_ajax3"></div>
			  ...
			  <div class="form-group">
				...
				<div class="col-sm-8">
				  <input type="password" class="form-control" id="user_password_new3" name="user_password_new3" placeholder="New Password" pattern=".{6,}" title="Password ( min. 6 characters)" required>
		  ...
		  <div class="modal-footer">
			...
			<button type="submit" class="btn btn-primary" id="actualizar_datos3">Change Password</button>
		  </div>
		  </form>
		</div>
	  </div>
