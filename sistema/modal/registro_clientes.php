	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Add new customer</h4>
		  </div>
		  <div class="modal-body">
			...
			<div id="resultados_ajax"></div>
			  ...
			  <div class="form-group">
				<label for="direccion" class="col-sm-3 control-label">Address</label>
				<div class="col-sm-8">
			  ...
			  <div class="form-group">
				<label for="estado" class="col-sm-3 control-label">State</label>
				<div class="col-sm-8">
