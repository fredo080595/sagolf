	  ...
	  <div class="modal-dialog" role="document">
		<div class="modal-content">
		  <div class="modal-header">
			...
			<h4 class="modal-title" id="myModalLabel"><i class='glyphicon glyphicon-edit'></i> Edit client</h4>
		  </div>
		  <div class="modal-body">
			...
			<div id="resultados_ajax2"></div>
			  ...
			  <div class="form-group">
				<label for="mod_direccion" class="col-sm-3 control-label">Addres</label>
				<div class="col-sm-8">
