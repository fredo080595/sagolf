	...
	if (isset($_GET['id'])){
		...
		if ($count==0){
			...
			<div class="alert alert-success alert-dismissible" role="alert">
			  ...
			  <strong>Aviso!</strong> Data deleted successfully.
			</div>
			<?php 
		}else {
			?>
			...
			<div class="alert alert-danger alert-dismissible" role="alert">
			  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
			  <strong>Error!</strong> Could not delete this product. There are quotes linked to this product.
			</div>
			<?php
		}
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
						...
						if ($status_producto==1){$estado="Active";}
					...
					<a href="#" class='btn btn-default' title='Edit product' onclick="obtener_datos('<?php echo $id_producto;?>');" data-toggle="modal" data-target="#myModal2"><i class="glyphicon glyphicon-edit"></i></a> 
					<a href="#" class='btn btn-default' title='Delete product' onclick="eliminar('<?php echo $id_producto; ?>')"><i class="glyphicon glyphicon-trash"></i> </a></span></td>
