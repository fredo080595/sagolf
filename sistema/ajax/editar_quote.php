<?php
	...
	if (empty($_POST['id_cliente'])) {
		...
		} else if ($_POST['estado_quote']==""){
			$errors[] = "Selecciona el estado de la quote";
		} else if (
		...
		$estado_quote=intval($_POST['estado_quote']);
		
		$sql="UPDATE quote SET id_cliente='".$id_cliente."', id_vendedor='".$id_vendedor."', condiciones='".$condiciones."', estado_quote='".$estado_quote."' WHERE id_quote='".$id_quote."'";
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				$messages[] = "quote updated successfuly.";
			} else{
