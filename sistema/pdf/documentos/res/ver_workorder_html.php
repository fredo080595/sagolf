...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_wo, workorder where products.id_producto=detalle_wo.id_producto and detalle_wo.numero_wo=workorder.numero_wo and workorder.id_wo='".$id_workorder."'");
