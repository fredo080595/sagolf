...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <?php include("encabezado_workorder.php");?>
    <br>
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
           <th style="width:50%;" ><u>WORK ORDER:</u> </th>
        </tr>
		<tr>
           <td style="width:50%;" >
			<?php 
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 10pt;">
        <tr>
            ...
            <th style="width: 15%;text-align: right" ><u>AMOUNT</u> </th>
...
while ($row=mysqli_fetch_array($sql))
	...
	$insert_detail=mysqli_query($con, "INSERT INTO detalle_wo VALUES ('','$numero_workorder','$id_producto','$cantidad','$precio_venta_r')");
...
$insert=mysqli_query($con,"INSERT INTO workorder VALUES (NULL,'$numero_workorder','$date','$id_cliente','$id_vendedor','$condiciones','$total_factura','1')");
