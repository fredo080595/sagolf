...
<page backtop="15mm" backbottom="15mm" backleft="15mm" backright="15mm" style="font-size: 12pt; font-family: arial" >
    ...
    <table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
        <tr>
<th style="width:50%;" ><u>QUOTATION:</u> </th>        </tr>
		<tr>
           <td style="width:50%;" >
			<?php 
       ...
       <br>
		...
		<tr>
		  ...
		  <td style="width:25%;"><?php echo date("d/m/Y", strtotime($fecha_quote));?></td>
		   <td style="width:40%;" >
				<?php 
...
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from products, detalle_quote, quote where products.id_producto=detalle_quote.id_producto and detalle_quote.numero_quote=quote.numero_quote and quote.id_quote='".$id_quote."'");
