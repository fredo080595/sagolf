  ...
  <body>
	...
	<div class="panel panel-info">
		<div class="panel-heading">
			<h4><i class='glyphicon glyphicon-edit'></i> New Work Order</h4>
		</div>
		...
		?>
			<form class="form-horizontal" role="form" id="datos_workorder">
				<div class="form-group row">
				  ...
				  <div class="col-md-3">
					  <input type="text" class="form-control input-sm" id="nombre_cliente" placeholder="write and select a client name" required>
					  <input id="id_cliente" type='hidden'>	
				  </div>
				  <label for="tel1" class="col-md-1 control-label">Phone</label>
							<div class="col-md-2">
								<input type="text" class="form-control input-sm" id="tel1" placeholder="Phone" readonly>
							</div>
					<label for="mail" class="col-md-1 control-label">Email</label>
						...
						<div class="form-group row">
							<label for="empresa" class="col-md-1 control-label">Vendor</label>
							<div class="col-md-3">
							...
							<label for="email" class="col-md-1 control-label">Payment</label>
							<div class="col-md-3">
	...
	<script type="text/javascript" src="js/nueva_workorder.js"></script>
